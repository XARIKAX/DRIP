  ...
  return (
    <div className="rise-group space-y-10">
      <header className="max-w-2xl">
        <div className="eyebrow text-cyan-dark">The credit side</div>
        <h1 className="mt-2 text-headline font-extrabold">Borrow</h1>
    ...
    <section className="panel lg:col-span-2" aria-label="Your carry">
      ...
      <div className="grid gap-px bg-panel-line sm:grid-cols-2">
        ...
        <div className="bg-panel p-6">
          ...
          <div className="num mt-3 text-[26px] font-semibold tracking-tighter text-paper">
      ...
      <div className="space-y-4 p-5">
        ...
        <dl className="text-[13px]">
          <div className="flex justify-between border-b border-panel-line py-2">
            ...
            <dd className="num text-paper">{c.borrowAprPct.toFixed(1)}% APR</dd>
          </div>
          <div className="flex justify-between border-b border-panel-line py-2">
            <dt className="text-panel-muted">USDG in wallet</dt>
            <dd className="num text-paper">${fmt(wallet.usdg)}</dd>
          </div>
          <div className="flex justify-between py-2">
            <dt className="text-panel-muted">Liquidation threshold</dt>
            <dd className="num text-paper">{c.liqThresholdPct.toFixed(0)}% LTV</dd>
          </div>
        </dl>
...
function HowItWorks() {
  ...
  return (
    <section aria-label="How borrowing works" className="space-y-6">
      <div>
        <div className="eyebrow text-cyan-dark">How it works</div>
        <div className="mt-4">
          {rows.map((r) => (
      ...
      {holdings.rows.length > 0 ? (
        <div className="border border-ink">
          <div className="flex items-baseline justify-between border-b border-ink px-5 py-3">
            ...
            <span className="text-micro font-bold uppercase text-muted">Keeps earning while pledged</span>
          </div>
          <div className="grid grid-cols-2 gap-px bg-faint p-px sm:grid-cols-3 lg:grid-cols-6">
            {holdings.rows.map((h) => (
